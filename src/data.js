...
export const uiText = {
  en: {
    ...
    projectDetail: {
      ...
      detailContentTitle: "Project Detail Content",
      openDetailContent: "Open Detail Content",
  ...
  ko: {
    ...
    projectDetail: {
      ...
      outcomes: "성과",
      reflection: "회고",
      detailContentTitle: "프로젝트 상세 내용",
      openDetailContent: "상세 내용 보기",
...
export const experiences = [
  ...
  },
  {
    ...
    koDescription:
      "XR Team / Unity Part에서 Unity 기반 AR/VR 앱 개발을 담당했습니다. 현대백화점 면세점 AR 콘텐츠, 서울시 AR 내비게이션, 경주로 ON AR 상점 스캔, SPC 섹타나인 Happyreal 프로젝트를 수행했습니다.",
    apps: [
